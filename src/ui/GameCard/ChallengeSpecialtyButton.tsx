...
const ChallengeSpecialtyButton: FC<Props> = ({ specialty }) => {
  ...
  const specialtyImageMap: { [key: string]: ReactNode } = {
    ...
    'o+d': (
      <div className="button" title="Type of the range - Offensive + Defensive">
        <div className="indicator custom-icon">
          <RedBlueIcon />
        </div>
        <CardButtonLeftRedBlue />
...
export default ChallengeSpecialtyButton;
